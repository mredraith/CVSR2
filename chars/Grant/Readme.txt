				 ...
				 Grant By Infinite 
___________________________________________________________ 05/03/2015
Contact:	mrinfinite@live.com
Website:	http://infiniteff.forumotion.com
Customized version of SNK PLAYMORE's Grant character, for MUGEN 1.0
...
.Ankoku Otoshi		         		F/B + 2P		(near opponent)
.Ramuzuhon					F/B + 2K		(near opponent)
.Ankoku Orochi					D + 2P			(near downed opponent)
.Supaiku no kikkudaun				F+HK


<SPECIAL>

.Messhou Hisetsu (EX)				D+K			(AIR)	
.Kyou Choujin (EX)				F,D,DF+P
	-Cancel					2P
.Gou Retsu-Shou (EX)				F,B,F+P		or 	D,DF,F+P
.Gou Dangai (EX)				D,DF,F+K
.Kokuen-ryu (EX)				D,DB,B+P
.Majin Gan (EX)					D,DB,B+K

<SUPERS>

.Majin Haten Dan				D,DF,F,D,DF,F+P  POWER>=1000  
.Majin Gou Dangai				D,DB,B,D,DB,B+P  POWER>=1000  
.Majin Engetsu Rin				D,DF,F,D,DF,F+K  POWER>=1000
.Max Majin Haten Dan				D,DF,F,D,DF,F+2P  POWER>=2000  
.Max Majin Gou Dangai				D,DB,B,D,DB,B+2P  POWER>=2000  
.Max Majin Engetsu Rin				D,DF,F,D,DF,F+2K  POWER>=2000
.Ankoku Basuto-ha				D,DF,F,D,DF,F+PK  POWER>=3000	(Charge)
.Ankoku Baria					D,DB,B,D,DB,B+PK  POWER>=3000
...
Abuhachi-Character Sprites and sounds.
...
Yzan-Testing and Feedback.

Hades-For the small portraits.

HungryWolf-For the big portrait.

AltherPrimus, Balthazar, Flowrellik, Girard, Gogngos, Knuckles, MCX, QuickFIst, Sabockee- For making palettes


=====<Disclaimer>=====

 - The Grant is property of SNK
 - Garou: Mark of the WOlves is property of SNK
