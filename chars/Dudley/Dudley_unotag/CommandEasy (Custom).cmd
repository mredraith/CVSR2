...
[State -1, Rolling Thunder]
type = ChangeState
value = ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && (Partner, Time >= 9) && power >= ifelse(partner,var(1)>1 && (partner, name = "Akuma" && partner, authorname = "Mr.Ansatsuken"),2000,3000), 1251125, ifelse(power>=3000,3200,3050))
...
[State -1, Rocket Uppercut]
type = ChangeState
value = ifelse(power>=2000,3100,3010)
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && power >= 1000 && power < 3000
triggerall= ceil(enemynear, stateno!=[120,155]) && (p2statetype!=L) && enemynear, ctrl = 0
