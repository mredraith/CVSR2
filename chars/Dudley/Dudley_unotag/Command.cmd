...
trigger2 = Random < (((8 * ifelse(MoveContact, ifelse(MoveHit, 4, 3),2)) + (UniqHitCount * 4)) *(var(59)**2/64.0))
trigger3 = var(59) >  0
...
trigger2 = Random < (((ifelse(sysvar(4)=15,400,750)*(var(59)**2/64.0)) + ((hitdefattr = SCA, SA, HA)*120) + ifelse(lifemax/life > 15, 80, lifemax/life)))
trigger2 = Partner, Life > Lifemax/10 || Life <= Partner, Life
trigger2 = Partner, Time > 25
trigger3 = var(59) >  0
trigger3 = Partner, Time > 27
trigger3 = Random < (500*(3*(Life = (Lifemax/4) && Life < Partner, Life)) *(var(59)**2/64.0))
...
trigger1 = var(59) <=  0
trigger2 = var(59) >  0
trigger2 = Random < (ifelse((LifeMax/Life > 120), 960, (LifeMax/Life)*8)+((EnemyNear,statetype=L)*200))
...
trigger3 = Random < (((ifelse(LifeMax/Life > 10, 20, LifeMax/Life) + (20+ifelse((EnemyNear, StateNo > 5000),50,2))) * ifelse((Life < Partner, Life), 2, 0.75))*8)
...
trigger4 = Random < (1000*4*(var(59)**2/64.0))
...
[State -1, Rocket Uppercut]
type = ChangeState
value = ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner,name!="Dudley"||partner,authorname!="DickBuckus&Mr.Ansatsuken")&&((partner,name!="Akuma"&&partner,name!="Q")||partner,authorname!="Mr.Ansatsuken")&&((partner,name!="Ryu"&&partner,name!="Dan Hibiki")||partner,selfanimexist(4201533)=0||partner,authorname!="Phantom.of.the.Server")) && (Partner, Time >= 9) && power >= 3000, 1251125, ifelse(power>=2000,3100,3010))
triggerall= var(7)>=1 && roundstate=2 && statetype!=A && power >= 1000 && power < ifelse((sysvar(4) = 1 || sysvar(4) = 15) && (numpartner) && (partner, life > 0) && (Partner, StateNo = [1251112,1251114]) && ((partner,name!="Dudley"||partner,authorname!="DickBuckus&Mr.Ansatsuken")&&(partner,name!="Akuma"||partner,authorname!="Mr.Ansatsuken")&&((partner,name!="Ryu"&&partner,name!="Dan Hibiki")||partner,selfanimexist(4201533)=0||partner,authorname!="Phantom.of.the.Server")) && (Partner, Time >= 9), powermax*2, 3000)
triggerall= ceil(enemynear, stateno!=[120,155]) && (p2statetype!=L) && enemynear, ctrl = 0
