				 ...
				 LAURENCE BLOOD By R@CE AKIR@ 
___________________________________________________________ 6/11/2014
Contact:	bladex45@yahoo.com
Website:	http://infiniteff.forumotion.com
Customized version of SNK's Laurence Blood character, for MUGEN 1.0
...
.Matador Slash		         	F/B + 2P		(near opponent)
.Flying Buster				F/B + 2K		(near opponent)
.Air Flying Buster                      F/B + 2P		(near opponent)

<SPECIAL>

.Bloody Saber (EX)	                D,DF,F+P (x3 for more hits)
.Bloody Shooter (EX) 	                D,DF,F+P (Only in The Air)		
.Bloody Cutter (EX)                     F,D,DF+P
.Bloody Spin (EX)	                D,DB,B+K
.Bloody Impaler (EX)                    D,DF,F+K
.Bloody Press (EX)                      B,D,DB+P
.Bloody Mixer (EX)                      D,DB,B+P
...
.Bloody Flash	                        D,DF,F,D,DF,F+P  POWER>=1000  
.Bloody Hail Shooter 	                D,DF,F,D,DF,F+P  POWER>=1000 (Only in The Air) 	 
.Bloody Blender                         D,DB,B,D,DB,B+P  POWER>=1000
.Bloody Sabre Combination               D,DF,F,D,DF,F+K  POWER>=1000 
.Bloody Wild Spin                       D,DB,B,D,DB,B+K  POWER>=1000 

.Max Bloody Flash	                D,DF,F,D,DF,F+2P POWER>=2000
.Max Bloody Hail Shooter 	        D,DF,F,D,DF,F+2P POWER>=2000 (Only in The Air)
.Max Bloody Blender                     D,DB,B,D,DB,B+2P POWER>=2000  
.Max Bloody Sabre Combination           D,DF,F,D,DF,F+2K POWER>=2000 
.Max Bloody Wild Spin                   D,DB,B,D,DB,B+2K POWER>=2000

.Final Death Bloody			D,DF,F,D,DF,F+PK POWER>=3000
.Bloody Shadow		                D,DB,B,D,DB,B+PK POWER>=3000
.Bloody Bull Rampage                    D,DB,B,D,DF,F+PK POWER>=3000
...
FUJY - For using his Sff that was in his Laurence Blood as a base to make my own Laurence Blood.

Garuda = For commisioning me to make Laurence Blood and also for motivation. Thanks dude!
...
Hungry Wolf - For making normal potraits for Laurence Blood

Hades - Thanking him in advance because I know he will make custom portraits for Laurence Blood
...
=====<Disclaimer>=====
 ...
 - Laurence Blood is property of SNK
