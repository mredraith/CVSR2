...
triggerAll = !AILevel
triggerAll = var(1)
triggerAll = (command = "EXougaFwd" || command = "EXougaBack")
triggerAll = RoundState = 2 && StateType != A
triggerAll = power >= 500 && var(20) <= 60
trigger1 = ctrl || StateNo = 40 || StateNo = 52 || (StateNo = [100,101])
trigger2 = var(6)
...
triggerAll = !AILevel
triggerAll = var(1)
triggerAll = (command = "OugaFwd" || command = "OugaBack")
triggerAll = RoundState = 2 && StateType != A
