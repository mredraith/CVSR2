...
===========================| Todoh by varo_hades		              |===========================
 ...
 - Customized version of Snk's Todoh character, for MUGEN 1.0

=====<Features>=====

 - All the essential stuff
 - Details and moves taken from his various video game appearances
 - Gameplay mixed from several games, including CvS2, KOF, AOF
 - Special intros versus Maki, Ryo, Robert, Yuri, Takuma, Mr.Karate, Geese And Mr.Big
...
.Low Kick				F + b
.Throw 1:	         		F/B + 2p		(near opponent)
.Throw 2:				F/B + 2k		(near opponent)

<SPECIAL>

.Kasane Ate (EX) (Air)			D, DF, F, p
.Taikuu (EX)				F, D, DF, p
.Stunning Grab (EX)			D, DB, B, p

<SUPER>

.Chou Kasane Ate (MAX):			D, DF, F, D, DF, F, p

<Lv3 SUPER>

.Shingan Kuzu Otoshi:                	D, DF, F, D, DB, B, mp+mk
...
=====<Special Thanks>=====
 - warusaki3 for sprites, anims, code
 - P.o.t.S. for code, effects, hitsparks, formatting style
 - Jadeeye and Varo_Hades for hyper fonts, hyper portrait
 - Everybody at the MUGEN Fighters Guild for feedback
 - The MUGEN Fighters Guild for providing hosting

=====<Disclaimer>=====

 - Todoh character is property of Snk
 - Capcom vs SNK is property of Capcom
 - This MUGEN character is a non-profit fan work, it cannot be used for any commercial purposes

=====<Things That Was Edited And Added To Todoh>===== ;NOTE THESE ARE THINGS I ALWAYS DO WHEN I EDIT AND FIX UP A POTS STYLE CHARS 
